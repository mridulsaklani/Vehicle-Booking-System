from pydantic import BaseModel, Field, EmailStr, field_validator,conint
...
class KycDetail(BaseModel):
    ...
    driving_experience: Optional[int] = Field(default=None)
...
class Address(BaseModel):
    ...
    pincode: conint(ge=100000, le=999999) = Field(..., example=123456)
